...
const AddProduct = () => {    
    ...
    const CONTRACT_ADDRESS  = '0x2D21ab40b91e931cE6490D958FD89854Fd76BCBC';
    ...
    return (
        <Box sx={{
            ...
            <Paper elevation={3} sx={{ width: "400px", margin: "auto", marginTop: "10%", marginBottom: "10%", padding: "3%", backgroundColor: "#202748b8",color:"white"}}>
                <Typography
                    variant="h2"
                    sx={{
                        textAlign: "center", marginBottom: "3%",
                        fontFamily: 'Gambetta', fontWeight: "bold", fontSize: "2.5rem",color:'white'
                    }}
                >
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Button
                        ...
                        component="label"
                        fullWidth
                        sx={{ marginTop: "3%", marginBottom: "3%",backgroundColor: "#8d234b" ,
                        color:"white" }}
                    >
                        Upload Image
                        <input
                    ...
                    <Button
                        variant="contained"
                        type="submit"
                        sx={{ width: "100%", marginTop: "3%", backgroundColor: '#ab2e56', '&:hover': { backgroundColor: '#8d234b' } }}
